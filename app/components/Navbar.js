            ...
            <div className="p-4 space-y-1">
              {navLinks.map((link, index) => (
                link.dropdown ? (
                  <div key={index} className="rounded-xl overflow-hidden">
                    ...
                    >
                      <span className="flex items-center gap-3">
                        <span className="w-8 h-8 flex items-center justify-center bg-gray-100 rounded-lg text-sm">🔧</span>
                        {link.label}
                      </span>
                      <svg 
                  ...
                  >
                    <span className="w-8 h-8 flex items-center justify-center bg-gray-100 rounded-lg text-sm">
                      {link.href === '/' && '🏠'}
                      {link.href === '/about' && 'ℹ️'}
                      {link.href === '/buy-rent' && '🏷️'}
                      {link.href === '/blog' && '📝'}
                      {link.href === '/contact' && '📞'}
                    </span>
                    {link.label}
